...
#----- Load JSON data -----#
with open('Which-wub-knows-how-the-toy-works-_all-responses-identifiable.json', 'r') as json_file:
    ...
    if participantCount > 23:
        ...
        if (hashedId not in acceptedChildHashedIds) and (hashedId not in pilotHashedIds):
            ...
            if '14-trial-segment' in expData:
                ...
                knowledge = "" 
                if (str(firstVideo).find("postfail") != -1 and selected == "left") or (str(firstVideo).find("prefail") != -1 and selected == "right"):
                    knowledge = 1
                else:
                    knowledge = 0
                ...
                row = [
                    ...
                    firstVideo,
                    "sneeze" if str(conditionData['parameterSet']['VIDEO-1'])[-9:-3] == "sneeze" else "speech",
                    selected,
                    knowledge,
                    "",
...
output_file = 'IKC datasheet.xlsx'
